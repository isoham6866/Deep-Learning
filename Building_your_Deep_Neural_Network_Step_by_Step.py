...
"""
Created on Sun July 16 09:26:34 2018
@author: soham ghosh
"""
import numpy as np
import h5py
...
def linear_activation_forward(A_prev, W, b, activation):
    ...
    if activation == "sigmoid":
        ...
        A, activation_cache = [], None
        Z, linear_cache = linear_forward(A_prev, W, b)
        A, activation_cache = ((np.exp(Z)-np.exp(-Z))/(np.exp(Z)+np.exp(-Z))), Z
...
def L_model_backward(AL, Y, caches):
    ...
    for l in reversed(range(L-1)):
        ...
        dA_prev_temp, dW_temp, db_temp = dA, None, None
        dA, dW_temp, db_temp = linear_activation_backward(dA_prev_temp, current_cache, "relu")
        grads["dA" + str(l)] = None
        grads["dW" + str(l + 1)] = None
        grads["db" + str(l + 1)] = None
        grads["dA" + str(l)], grads["dW" + str(l + 1)], grads["db" + str(l + 1)] = dA, dW_temp, db_temp
        ### END CODE HERE ###
